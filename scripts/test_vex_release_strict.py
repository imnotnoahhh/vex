...
EXPECTED_TOP_LEVEL_COMMANDS = {
    ...
    "alias": "Manage user-defined version aliases",
    "lock": "Generate lockfile from current .tool-versions",
    "sync": "Install missing versions from the current managed context",
