use crate::commands::python::env::find_active_python_bin;
...
pub(in crate::commands::python) fn init() -> Result<()> {
...
pub(in crate::commands::python) fn freeze() -> Result<()> {
    let cwd = resolver::current_dir();
...
pub(in crate::commands::python) fn sync() -> Result<()> {
    let cwd = resolver::current_dir();
